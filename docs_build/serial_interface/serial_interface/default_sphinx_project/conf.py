...
import os
import sys
sys.path.insert(0, os.path.abspath(os.path.join('/home/anthony/packbionics-ws/src/serial_interface/serial_interface', '..')))
...
copyright = 'The <serial_interface> Contributors. License: MIT'
author = """anthony"""
