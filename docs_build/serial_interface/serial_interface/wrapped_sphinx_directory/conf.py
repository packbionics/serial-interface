...
exec(open("/home/anthony/packbionics-ws/src/serial_interface/docs_build/serial_interface/serial_interface/default_sphinx_project/conf.py").read())
...
ensure_global('project', "serial_interface")
ensure_global('author', """anthony""")
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "serial_interface Doxygen Project": "/home/anthony/packbionics-ws/src/serial_interface/docs_build/serial_interface/output_staging/generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/anthony/packbionics-ws/src/serial_interface/docs_build/serial_interface/serial_interface/wrapped_sphinx_directory/generated",
